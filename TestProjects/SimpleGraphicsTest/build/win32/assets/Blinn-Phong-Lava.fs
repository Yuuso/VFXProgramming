...
{
	float noise = Turbulence(position * NoiseFrequency + Animation*t, 0.1, 1.5, 0.03) * NoiseAmplitude;
...
void main()
{
	...
	float rotx = coord.y * 3.0;
	float roty = -coord.x * 3.0;
	float zoom = 10.0;
	...
	gl_FragColor = col * g_Material.vAmbient;
